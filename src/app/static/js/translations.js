...
export const I18N = {
  "pt-BR": {
    ...
    scan_hint: "Aponte a câmera para o código.",
    scan_camera: "Câmera",
    scan_zoom: "Zoom",
    scan_result_label: "Código lido",
    scan_copy: "Copiar",
    scan_close: "Fechar",
    scan_error: "Não foi possível acessar a câmera.",
    image_view_alt: "Imagem ampliada",
  ...
  "en-US": {
    ...
    scan_hint: "Point the camera at the code.",
    scan_camera: "Camera",
    scan_zoom: "Zoom",
    scan_result_label: "Decoded code",
    scan_copy: "Copy",
    scan_close: "Close",
    scan_error: "Could not access the camera.",
    image_view_alt: "Enlarged image",
