...
### 3. Instale a dependência e baixe o dataset
...
Use os valores de **workspace**, **project** e **version** copiados no passo
anterior para baixar o dataset via SDK do Roboflow (snippet Python do próprio
Roboflow, mostrado no passo 2).

O download deve ficar em uma pasta dedicada (por exemplo,
`datasets/roboflow_barcode/`). Trate essas imagens como **conjunto de teste de
generalização**: avalie o modelo nelas, mas não as inclua no treino.
